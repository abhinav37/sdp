# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-12-02 11:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FileComponent',
            fields=[
                ('component_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='main.Component')),
                ('file', models.FileField(blank=True, default=None, null=True, upload_to=main.models.fileUploadPath)),
            ],
            bases=('main.component',),
        ),
        migrations.CreateModel(
            name='VideoComponent',
            fields=[
