...
urlpatterns = [
	...
	url(r'^completedCourses/(?P<course_id>\d+)/$', views.viewFullContent, name='completedCourses'),
	...
	url(r'^instructor/new/addModule/$', views.addModule, name='addModule'),
	...
	url(r'^admin/renamecat/$', views.renameCategory, name='renamecat'),
